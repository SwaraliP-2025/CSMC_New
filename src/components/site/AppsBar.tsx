...
const APPS: {
  ...
  { name: "Saksham", nameMr: "सक्षम", img: sakshamImg, url: "https://play.google.com/store/apps/details?id=com.mars.saksham&hl=en_IN" },
...
export const AppsBar = () => {
  ...
  const pendingTitle = en

    ? "Saksham — official store link not available in this prototype"
    ...
    <div className="bg-civic-ink border-t border-white/10 py-4">
      ...
      <div className="container">
        ...
        <p className="text-xs uppercase tracking-widest font-bold text-civic-gold mb-3 text-center">
          ...
          {en ? "Download Our Apps" : "आपले ॲप डाउनलोड करा"}
          ...
          {APPS.map((app) =>
            ...
            app.unavailable || !app.url ? (
              ...
              <div
                ...
                className="flex flex-col items-center gap-1.5 bg-white/5 border border-white/10 rounded-xl p-2.5 opacity-70 cursor-not-allowed"
              ...
              >
                ...
                <p className="text-civic-gold/80 text-[8px] font-bold text-center leading-tight">

                  {en ? "Link pending" : "दुवा प्रलंबित"}
          ...
          {APPS.map((app) =>
            ...
            app.unavailable || !app.url ? (
              ...
              <div
                ...
                className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-lg px-3 py-2 opacity-70 cursor-not-allowed"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-civic-gold text-[9px] font-bold">{en ? "Link pending" : "दुवा प्रलंबित"}</p>
