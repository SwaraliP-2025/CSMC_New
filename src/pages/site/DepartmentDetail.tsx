...

{
  ...
  headEn: "Shri Santosh Wahule",
  headMr: "श्री संतोष वाहूळे",
   ...
   * ============================================================ */
  {
    slug: "commissioner-office",
    nameEn: "Commissioner Office",
    nameMr: "आयुक्त कार्यालय",
    headEn: "Shri Anil Bonde",
    headMr: "श्री. अनिल बोंडे",
    designationEn: "In-Charge Additional Commissioner",
  ...
  {
    slug: "accounts-department",
    nameEn: "Accounts Department",
    nameMr: "लेखा विभाग",
    headEn: "Shri Santosh Wahule",
    headMr: "श्री. संतोष वाहूळे",
    designationEn: "Chief Accounts & Finance Officer",
    designationMr: "मुख्य लेखा व वित्त अधिकारी",
    phone: DEPARTMENT_CONTACT_PHONE,
    email: "",
    addressEn: "CSMC Main Building, Town Hall, Chhatrapati Sambhajinagar - 431001",
    addressMr: "छत्रपती संभाजीनगर महानगरपालिका, मुख्य इमारत, टाऊन हॉल, छत्रपती संभाजीनगर, ४३१००१",
  ...
  {
    slug: "town-planning-department",
    nameEn: "Town Planning Department",
    nameMr: "नगररचना विभाग",
    headEn: "Smt. Dipali Patil",
    headMr: "श्रीमती दिपाली पाटील",
    designationEn: "Deputy Director, Town Planning",
  ...
  
  {
    ...
    nameMr: "लेखापरीक्षण विभाग",
    headEn: "Shri Shivaji Naikwade",
    headMr: "श्री. शिवाजी नाईकवाडे",
    designationEn: "Chief Auditor",
  ...
  {
    slug: "municipal-secretary-department",
    nameEn: "Municipal Secretary Department",
    nameMr: "महापालिका सचिव विभाग",
    headEn: "Shri Nandkishor Bhombe",
    headMr: "श्री. नंदकिशोर भोंबे",
    designationEn: "In-Charge Municipal Secretary",
    designationMr: "प्र. महापालिका सचिव",
    phone: DEPARTMENT_CONTACT_PHONE,
    email: "",
    addressEn: "CSMC Main Building, Town Hall, Chhatrapati Sambhajinagar - 431001",
    addressMr: "छत्रपती संभाजीनगर महानगरपालिका, मुख्य इमारत, टाऊन हॉल, छत्रपती संभाजीनगर, ४३१००१",
  ...
  {
    slug: "statistics-cell",
    nameEn: "Statistics Cell",
    nameMr: "सांख्यिकी कक्ष (विविध विभागांची माहिती संकलित करणे)",
    headEn: "Shri Anil Bonde",
    headMr: "श्री. अनिल बोंडे",
    designationEn: "In-Charge Additional Commissioner",
    designationMr: "प्र. सहायक आयुक्त",
