  ...
  return (
    <Layout>
      <PageHeader
        ...
        title={en ? "Hon'ble Deputy Mayors' List" : "मा. उपमहापौरांची यादी"}
        subtitle={en ? "List of Hon'ble Deputy Mayors of Chhatrapati Sambhajinagar Municipal Corporation." : "छत्रपती संभाजीनगर महानगरपालिकेच्या मा. उपमहापौरांची यादी."}
      />
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-civic-blue text-white">
                ...
                <th className="px-4 py-4 text-left font-bold">{en ? "Hon'ble Deputy Mayor" : "मा. उपमहापौर"}</th>
                  ...
                  <td className="px-4 py-4">
                    ...
                    {m.current && (
                      <span className="inline-block mt-1 bg-green-100 text-green-700 font-bold px-2 py-0.5 rounded-full text-[10px]">
                        {en ? "Current Deputy Mayor" : "विद्यमान उपमहापौर"}
                      </span>
                    )}
                  </td>
                  ...
                  <td className="px-4 py-4 text-center">
                    <div
                      ...
                      onClick={() => m.img && setSelected({
                        ...
                        role: en ? "Hon'ble Deputy Mayor" : "मा. उपमहापौर",
                      })}
                    >
...
export default DeputyMayorsList;
